...
if( !function_exists('wpdams_plugin_scripts')) {
    function wpdams_plugin_scripts() {
        ...
        wp_enqueue_script('amsjsajaxcrypto', WPD_AMS_PLUGIN_DIR. 'assets/js/amscrypto.js', 'jQuery', '3.1.9', true );

        wp_enqueue_script('amsjsajaxcookies', WPD_AMS_PLUGIN_DIR. 'assets/js/ams.cookie.min.js', 'jQuery', '1.4.1', true );
                ...
                echo "<div class='listview-events'>";
                  echo "<div class='productstyle-list-items'>";
                        ...
                        if (isset($organizationevents))
                        {
                          if(empty($x_value['organization_logo']))
                          {
                            echo "<a href='".site_url('/'.$pageslug.'/'.$pageslugid.'-'.$x_value['id'])."'>";
                            echo "<div class='product-img-wrap'>";
                                echo "<img src=".plugins_url( 'assets/img/bg-image.png', __FILE__ ) ." alt=".$x_value['name'].">";
                            echo "</div>"; 
                            echo "</a>";   
